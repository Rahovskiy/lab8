...
import bsu.rfe.java.group7.lab4.Rahovskiy.varA8.ChatUser;
...
// Вывести форму
        pw.println("<form action='/lab8_war_exploded/' method='post'>Введите имя: <input type='text' name='name' value=''><input type='submit' value='Войти в чат'>");
